       ...
       <main>
        <div class="container">
            <div class="dashbord d1">
                    <div class="img-box">
                        <img src="./images/icons/newadd.png" alt="add" class="dashIcons">
                    </div>
                    <a class="dashLink dl1" href="./addProducts.php">Add Product</a>
            </div>
            <div class="dashbord d2">
                    <div class="img-box">
                        <img src="./images/icons/newmanageProducts.png" alt="add" class="dashIcons">
                    </div>
                    <a class="dashLink dl2" href="./viewProducts.php">Manage Products</a>
            </div>
            <div class="dashbord d3">
                    <div class="img-box">
                        <img src="./images/icons/newmanageUsers.png" alt="add" class="dashIcons">
                    </div>
                    <a class="dashLink dl3" href="./manageUsers.php">Manage Customers</a>
            </div>
        </div>
